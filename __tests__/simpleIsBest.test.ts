...
const cubeCards: CubeCard[] = [
  ...
  { name: 'Abiding Grace', oracle_text: 'At the beginning of your end step, choose one —\n• You gain 1 life.\n• Return target creature card with mana value 1 from your graveyard to the battlefield.', ambiguous: true },
  ...
  { name: 'Auriok Salvagers', oracle_text: '{1}{W}: Return target artifact card with mana value 1 or less from your graveyard to your hand.', ambiguous: true },
  ...
  { name: 'Inquisition of Kozilek', oracle_text: 'Target player reveals their hand. You choose a nonland card from it with mana value 3 or less. That player discards that card.', ambiguous: true },
  ...
  { name: 'Lightning Helix', oracle_text: 'Lightning Helix deals 3 damage to any target and you gain 3 life.', ambiguous: true },
  ...
  { name: 'Portable Hole', oracle_text: 'When this artifact enters, exile target nonland permanent an opponent controls with mana value 2 or less until this artifact leaves the battlefield.', ambiguous: true },
  ...
  { name: 'Ruin Grinder', oracle_text: 'Menace\nWhen this creature dies, each player may discard their hand and draw seven cards.\nMountaincycling {2} ({2}, Discard this card: Search your library for a Mountain card, reveal it, put it into your hand, then shuffle.)', ambiguous: true },
  { name: 'Sacred Foundry', oracle_text: '({T}: Add {R} or {W}.)\nAs this land enters, you may pay 2 life. If you don\'t, it enters tapped.' },
  { name: 'Savai Triome', oracle_text: '({T}: Add {R}, {W}, or {B}.)\nThis land enters tapped.\nCycling {3} ({3}, Discard this card: Draw a card.)' },
  { name: 'Scavenging Ooze', oracle_text: '{G}: Exile target card from a graveyard. If it was a creature card, put a +1/+1 counter on this creature and you gain 1 life.', ambiguous: true },
  ...
  { name: 'Spellseeker', oracle_text: 'When this creature enters, you may search your library for an instant or sorcery card with mana value 2 or less, reveal it, put it into your hand, then shuffle.', ambiguous: true },
