...
**YOU ARE IN: `parser/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/parser/` (rig root) or other directories
...
**Your mail address:** `parser/polecats/obsidian`
**Your rig:** parser
**Your Witness:** `parser/witness`
...
| Ask Witness for help | `gt mail send parser/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`parser/witness`) when:
...
```bash
gt mail send parser/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
